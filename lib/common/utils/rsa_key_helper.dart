// ignore_for_file: prefer_typing_uninitialized_variables, implementation_imports, constant_identifier_names
...
class CryptoUtils {
  ...
  static String wrapBase64PublicKeyWithHeaders(String key) {
    return '$BEGIN_PUBLIC_KEY\n$key\n$END_PUBLIC_KEY';
  }

  static String wrapBase64PrivateKeyWithHeaders(String key) {
